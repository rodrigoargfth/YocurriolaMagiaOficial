...
// Hook para obtener el ancho de un elemento
function useElementWidth(ref: RefObject<HTMLElement | HTMLDivElement>): number {
...
// Props para el subcomponente interno
...
export const ScrollVelocity = ({
  ...
  parallaxStyle,
  scrollerStyle,
}: ScrollVelocityProps): JSX.Element => {
  return (
    <section>
